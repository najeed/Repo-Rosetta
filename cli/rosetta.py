...
class RosettaCLI:
    ...
    def run(self):
        ...
        print("[+] Analysis complete. Results saved to: {}".format(args.output))
...
"""
        with open(os.path.join(args.output, "CODEBASE.md"), "w") as f:
            f.write(content)
    ...
    def _write_json_export(self, args):
        ...
        with open(os.path.join(args.output, "export.json"), "w") as f:
